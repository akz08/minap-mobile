...
//		}
		...
		if (patient.Gender.setPatientGender((byte)1))
			Toast.makeText(this, patient.Gender.getPatientGender(), Toast.LENGTH_LONG).show();
		else
			Toast.makeText(this, "Invalid Forename", Toast.LENGTH_LONG).show();
		
		if (patient.NHSVerification.setVerification((byte)8))
			Toast.makeText(this, patient.NHSVerification.getVerification(), Toast.LENGTH_LONG).show();
		else
			Toast.makeText(this, "Invalid GPCode", Toast.LENGTH_LONG).show();
