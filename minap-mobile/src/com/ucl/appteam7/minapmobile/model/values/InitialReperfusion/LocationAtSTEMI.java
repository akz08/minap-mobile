...
public class LocationAtSTEMI extends Value {
	...
	public static String getSTEMILocation() {
		return Byte.toString(locationAtSTEMI) + " - " + locationAtSTEMILongCode;
	}
	
	public static String getLongCode() {
		return locationAtSTEMILongCode;
	}
}
